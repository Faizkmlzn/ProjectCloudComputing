...
<head>
    ...
    <title>ABSENSI MIS NURUL YAQIN</title>
            ...
            <div class="container-fluid text-light">
                ...
                <div class="float-end">
                    <div class="d-flex text-end">
                        @auth
                            <a href="{{ route('dashboard.index', auth()->user()->role) }}" class="btn btn-primary" type="button"><i class="bi bi-person-gear"></i>&nbsp;Kelola</a>
                        @else
                            <a href="{{ route('login') }}" class="btn btn-primary" type="button"><i class="bi bi-person-fill"></i>&nbsp;Login</a>
                        @endauth
                    </div>
    ...
    <main>
        <div class="container marketing mt-5">
            ...
            <div class="px-4 py-5 my-5 text-center">
                <img class="d-block mx-auto mb-4" src="/img/logo.png" alt="" width="500px">
                <h1 class="display-5 fw-bold">SISTEM ABSENSI MIS NURUL YAQIN</h1>
                <div class="col-lg-6 mx-auto">
                    <p class="lead mb-4">
                        Selamat datang di Website Absensi MIS Nurul Yaqin! <br>
            ...
            @else
              ...
              <div class="row">
                  <h3 class="text-center mt-3 mb-2 fw-bold" style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">INFO KETIDAKHADIRAN HARI INI</h3>
                      ...
                      <div class="table-responsive">
                          <table class="table table-sm table-bordered table-hover">
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                    <td colspan="2" class="bg-dark text-white text-center align-middle fw-bold d-xs">Jumlah</td>
